...
impl<Prefix, Hasher, Key, Value, QueryKind, OnEmpty, MaxValues, PovEstimation>
	CountedStorageMap<Prefix, Hasher, Key, Value, QueryKind, OnEmpty, MaxValues, PovEstimation>
where
...
impl<Prefix, Hasher, Key, Value, QueryKind, OnEmpty, MaxValues, PovEstimation>
	...
	for CountedStorageMap<Prefix, Hasher, Key, Value, QueryKind, OnEmpty, MaxValues, PovEstimation>
where
	Prefix: CountedStorageMapInstance,
	Hasher: crate::hash::StorageHasher,
